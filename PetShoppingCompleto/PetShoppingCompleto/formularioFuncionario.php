...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conexao, "INSERT INTO funcionarios(nome, senha, email, re, telefone,data_nasc,cidade,estado,endereco) 
    VALUES('$nome', '$senha','$email','$re','$telefone','$data_nasc','$cidade','$estado','$endereco')");
}
        ...
        <div class="right-login">
            <div class="card-login">
                <form action="formulario.php" method="POST">
                    <fieldset>
                        <legend><b>Fórmulário de Cadastro Funcionarios</b></legend>
                        <div class="inputBox">
                        ...
                        <div class="inputBox">
                            <input type="text" name="re" id="re" class="inputUser" required placeholder="RE">
                            <label for="re" class="labelInput"></label>
                        </div>
                        <br><br>
                        <div class="inputBox">
